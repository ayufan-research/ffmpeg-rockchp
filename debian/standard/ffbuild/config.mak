...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr --extra-version=1ayufan2 --toolchain=hardened --libdir=/usr/lib/arm-linux-gnueabihf --incdir=/usr/include/arm-linux-gnueabihf --enable-gpl --disable-stripping --enable-avresample --disable-filter=resample --enable-avisynth --enable-gnutls --enable-ladspa --enable-libass --enable-libbluray --enable-libbs2b --enable-libcaca --enable-libcdio --enable-libflite --enable-libfontconfig --enable-libfreetype --enable-libfribidi --enable-libgme --enable-libgsm --enable-libjack --enable-libmp3lame --enable-libmysofa --enable-libopenjpeg --enable-libopenmpt --enable-libopus --enable-libpulse --enable-librubberband --enable-librsvg --enable-libshine --enable-libsnappy --enable-libsoxr --enable-libspeex --enable-libssh --enable-libtheora --enable-libtwolame --enable-libvorbis --enable-libvpx --enable-libwavpack --enable-libwebp --enable-libx265 --enable-libxml2 --enable-libxvid --enable-libzmq --enable-libzvbi --enable-lv2 --enable-omx --enable-openal --enable-opengl --enable-sdl2 --enable-rkmpp --enable-version3 --enable-libdc1394 --enable-libdrm --enable-libiec61883 --enable-chromaprint --enable-frei0r --enable-libopencv --enable-libx264 --cross-prefix=arm-linux-gnueabihf- --arch=armhf --target-os=linux --cc='distcc arm-linux-gnueabihf-gcc' --cxx='distcc arm-linux-gnueabihf-g++' --enable-shared
prefix=/usr
LIBDIR=$(DESTDIR)/usr/lib/arm-linux-gnueabihf
SHLIBDIR=$(DESTDIR)/usr/lib/arm-linux-gnueabihf
INCDIR=$(DESTDIR)/usr/include/arm-linux-gnueabihf
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)/usr/lib/arm-linux-gnueabihf/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=/usr/src/ffmpeg-3.5~git20180113
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=gcc 7 (Ubuntu/Linaro 7.3.0-27ubuntu1~18.04)
ARCH=arm
INTRINSICS=none
EXTERN_PREFIX=
CC=distcc arm-linux-gnueabihf-gcc
CXX=distcc arm-linux-gnueabihf-g++
AS=distcc arm-linux-gnueabihf-gcc
OBJCC=distcc arm-linux-gnueabihf-gcc
LD=distcc arm-linux-gnueabihf-gcc
DEPCC=distcc arm-linux-gnueabihf-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=distcc arm-linux-gnueabihf-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2 -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
CFLAGS=-g -O2 -fdebug-prefix-map=/usr/src/ffmpeg-3.5~git20180113=. -fstack-protector-strong -Wformat -Werror=format-security -fno-strict-overflow -fstack-protector-all -fPIE   -march=armv7-a -std=c11 -fomit-frame-pointer -fPIC -mthumb -pthread -I/usr/include/p11-kit-1 -I/usr/include/sratom-0 -I/usr/include/sord-0 -I/usr/include/serd-0 -I/usr/include/lilv-0 -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/arm-linux-gnueabihf/glib-2.0/include -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/fribidi -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/libxml2 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/bs2b   -I/usr/include/libdrm -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/fribidi -I/usr/include/opencv -I/usr/include/openjpeg-2.3  -I/usr/include/opus -I/usr/include/opus -D_REENTRANT -pthread -I/usr/include/librsvg-2.0 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/arm-linux-gnueabihf/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16                 -I/usr/include/libxml2   -I/usr/include/alsa       -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -D_REENTRANT -I/usr/include/SDL2
CXXFLAGS=-g -O2 -fdebug-prefix-map=/usr/src/ffmpeg-3.5~git20180113=. -fstack-protector-strong -Wformat -Werror=format-security  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=-g -O2 -fdebug-prefix-map=/usr/src/ffmpeg-3.5~git20180113=. -fstack-protector-strong -Wformat -Werror=format-security  
...
DEPWINDRES=distcc arm-linux-gnueabihf-gcc
DOXYGEN=doxygen
LDFLAGS=-Wl,-z,relro -Wl,-z,relro -Wl,-z,now  -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
